...
class CallLogAdapter(val logsData: ArrayList<CallLogData>, val listener : Listener) : RecyclerView.Adapter<CallLogViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CallLogViewHolder, position: Int) {
        holder.bind(logsData.get(position), listener)
    }

     interface Listener {
       fun onItemClick(logData: CallLogData)
    }
}